...
public class VaultManager implements Listener {
    ...
    private ElasticEconomy elasticEconomy = new io.github.anjoismysign.bloblib.vault.multieconomy.Absent();
    ...
    public void onUnregister(ServiceUnregisterEvent event) {
        ...
        switch (eventProvider.getService().getName()) {
            ...
            case "net.milkbowl.vault.economy.MultiEconomy" -> {
                elasticEconomy = new io.github.anjoismysign.bloblib.vault.multieconomy.Absent();
    ...
    public void onRegister(ServiceRegisterEvent event) {
        ...
        switch (eventProvider.getService().getName()) {
            ...
            case "net.milkbowl.vault.profile.Profile" -> {
                ...
                Bukkit.getLogger().fine("Vault Profile override");
            }
        }
    ...
    private boolean hasProfileProvider() {
        if (!packagesExists("net.milkbowl.vault.profile.Profile")) {
            Bukkit.getLogger().info("Not using Vault2, disabling Profile features");
            return false;
        }
